...
import * as actionStock from "../../actions/stock.action";
import * as actionShop from "../../actions/shop.action";
...
class Shop extends Component {
            ...
            <tr>
              <td className="td_orderline">
                ...
                <div>
                  ...
                  {item.qty} pcs.
                  <span
                    style={{ marginTop: 39, marginRight: 20, float: "right" }}
                    onClick={() => this.props.removeOrder(item)}
                  >
                    <i class="fa fa-fw fa-trash" style={{ fontSize: 20 }} />
                  </span>
                </div>
              </td>
            </tr>
  ...
  renderProductRows = () => {
    let { result } = this.props.stockReducer;
    return (
